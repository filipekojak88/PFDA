...
The `project` folder includes the Jupyter notebook `windspeed.ipynb` which is the main file, and presents full explanation on the steps performed to analyse the windspeed data from Mace Head in Galway. The folder also includes the downloaded `hly275.csv` file which contains the data downloaded from Met Eireann and used in `windspeed.ipynb`.
- **How to Run `windspeed.ipynb`**: Open the notebook, and execute the cells to visualize the weather data analysis and the several plots.

## Use of This Repository

### Assignments

These assignments show how to apply data analysis and simulation techniques using Python, Jupyter Notebooks, and various libraries like Pandas and Matplotlib. It helps students build essential skills in handling and analyzing datasets, creating visualizations, and performing simulations such as weather analysis or game outcomes.
